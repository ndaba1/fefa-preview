...
export default function Page(props: pageProps) {
  ...
  const meta = {
    ...
    description:
      'Fefa is an online academy with a focus on availing knowledge to everyone, for free. Free in every sense of the word.',
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://fefaacademy.me${router.asPath}`} />
