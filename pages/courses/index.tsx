...
import { IconHeart, IconJumpRope, IconSearch, IconStack3, IconStar } from '@tabler/icons';
...
const Index = () => {
  ...
  return (
    <Page
      customMeta={{
        title: 'Courses | Fefa Academy',
        description:
          'Fefa Academy Courses - Level up your skills. Learn at your own pace from our masterclass courses',
      }}
    >
      ...
      <section className={`${classes.showcase}`}>
        <Container className="max-w-7xl p-10 lg:px-16 flex flex-col lg:flex-row lg:pt-16 lg:items-center">
          <div className="w-full lg:w-1/2 space-y-7 ">
            <Text className="text-5xl font-semibold roboto">Level Up Your Skills 🚀 </Text>
            <Text className="text-xl">
              A collection of tutorials geared towards familiriazing you with the topics of your
              choosing. Our courses are masterclasses: designed to take you from a novice level or
              intermediate to expert.
            </Text>
            <Text className="text-xl">
              Didn&apos;t find what you&apos;re looking for? Head over to the community section and
              tell us what new course you&apos;d like. We take regular polls to help us decide what
            ...
            <Group>
              <Button
                ...
                leftIcon={<IconJumpRope />}
              >
                Jump In
              </Button>
              <Button size="lg" variant="outline" leftIcon={<IconSearch />}>
                Search
              </Button>
            </Group>
          </div>
