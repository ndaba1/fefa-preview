  ...
  return (
    <Page>
      <main className="mx-auto w-full max-w-7xl p-5 space-y-10 ">
        ...
        <section className="md:p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {HomepageCTAs.map((item, i) => (
            <Card
              key={i}
              shadow="xs"
              className={`flex items-center space-x-5 rounded-lg ${!dark && 'border-2'}`}
            >
              <div dangerouslySetInnerHTML={{ __html: item.icon }} />
              <div className="h-full border-[1px] rounded-md" />
        ...
        <section className="relative h-full rounded-md overflow-hidden p-5 md:p-7 text-black cursive">
          <Image
          ...
          <div className="grid gap-5 md:gap-8 grid-cols-1 md:grid-cols-2 p-3 md:p-8 md:px-14 relative !z-10">
            {ManifestoData.map((d, i) => (
              <div key={i} className="space-y-2">
                <Text className="text-xl text-center md:text-2xl font-semibold">{d.title}</Text>
                <Blockquote
                  color="dark"
        ...
        <section>
          <h2 className="text-center text-2xl md:text-4xl mb-5 md:mb-8">Ways you can support us</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {WaysToSupport.map((item, i) => (
              <Card key={i} shadow="xl" className={`${classes.customCard} rounded-xl`} p="xl">
        ...
        <Container className="max-w-7xl p-0 md:p-5 flex flex-col lg:flex-row items-center space-y-8 lg:space-x-8 lg:space-y-0">
          ...
          <div className="w-full lg:w-1/2 p-5 lg:p-0 pt-0">
            ...
            <Text className="text-xl">
              Hi, 👋. I&apos;m Victor Ndaba, the founder of this small academy. Fefa is like my
              perfect child: the Ruby to my Matz, the GOT to my HBO. I created it because I
              don&apos;t believe that free and high quality have to be mutually exclusive. Among
              other things, I am primarily a self-taught software developer and I have had to take a
              lot of courses to get to where I am today. I noticed that there&apos;s always this
              pattern where most free courses only offer you so much and the really good ones are
              not free, and even then, they may not be enough. Which is why Fefa is here,{' '}
      ...
      <Container className="max-w-7xl p-5 space-y-10">
        ...
        <section className="flex flex-col-reverse lg:flex-row justify-center items-center mb-5">
          <div className="w-full lg:w-1/2 mt-5 lg:mt-0">
            ...
            <Text className="text-xl">
              As stated above, Fefa is more than just another online academy. We are a community, a
              family more like, that will help you learn together and grow together. The Fefa
              Academy community is spread out over various social platforms and even on the Academy
              website itself. For code-related projects and programming in general, find us on{' '}
              <span className="underline text-blue-400">github</span>. Looking for a more serious
              and career-based fefa community? The{' '}
              <span className="underline text-blue-400">linkedin</span> group will suit your needs.
              The <span className="underline text-blue-400">discord server</span> is probably the
              most active community. This is the place for you if you&apos;re looking for a study
              partner to complete a course together, support regarding a specific course or lesson,
              or just any information related to Fefa in general. You can also follow us on{' '}
              <span className="underline text-blue-400">twitter</span>. As for my fellow redditors,
              I will see you on the <span className="underline text-blue-400">subreddit</span>.
            </Text>
          </div>
        ...
        <section className="grid gap-8 grid-cols-1 md:grid-cols-2 mb-8">
          <div className={`${classes.customCard} p-5  md:p-8 rounded-md shadow-md`}>
            <Text className="text-3xl roboto font-semibold mb-5">Before you go...</Text>
            <Text className="text-2xl mb-2">Subscribe to our newsletter</Text>
            <Text color="dimmed">
              You will never miss important updates, latest news and community QA and sessions. Our
          ...
          <div className={`${classes.customCard} p-5 md:p-8 rounded-md shadow-md`}>
            <Text className="text-3xl roboto font-semibold mb-5">You could also...</Text>
            <Text className="text-2xl mb-2">Sign the guestbook</Text>
            <Text color="dimmed" className="mb-2">
              Leave a message for future visitors. It can be anything from a review to an
              inside-joke to an awesome one-liner.{' '}
        ...
        {/* Faq section */}
        <h2 className="text-center text-3xl md:text-4xl font-medium">Frequently asked questions</h2>
